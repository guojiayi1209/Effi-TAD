annotation_path = "/root/autodl-tmp/adatad/data/thumos/thumos_14_anno.json"
class_map = "/root/autodl-tmp/adatad/data/thumos/category_idx.txt"
data_path = "/root/autodl-tmp/adatad/data/thumos/video"
block_list = None
