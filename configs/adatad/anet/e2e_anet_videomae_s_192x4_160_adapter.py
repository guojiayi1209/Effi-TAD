_base_ = [
    ...
    "/root/autodl-tmp/adatad/configs/_base_/models/adapter-1dtransformer-tridethead.py",  # model config
]
...
optimizer = dict(
    ...
    projection = dict(lr=5e-4, weight_decay=0.05),
    rpn_head = dict(lr=5e-4, weight_decay=0.05),
)
...
post_processing = dict(
    ...
    external_cls=dict(
        ...
        path="/root/autodl-tmp/adatad/data/anet/classifiers/cuhk_val_simp_7.json",
        topk=2,
    ),
    save_dict=False,
)
